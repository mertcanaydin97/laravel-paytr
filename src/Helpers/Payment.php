<?php
namespace Mertcanaydin97\LaravelPaytr\Helpers;

use Mertcanaydin97\LaravelPaytr\LaravelPaytrClient;
use Mertcanaydin97\LaravelPaytr\LaravelPaytrResponse;

class Payment extends LaravelPaytrClient
{
    /**
     * @var string
     */
    ...
    public function create()
    {
        ...
        return new LaravelPaytrResponse(json_decode((string)$response->getBody(), true));
    }
}
